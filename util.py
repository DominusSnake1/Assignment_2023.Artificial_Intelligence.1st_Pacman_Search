...
class PriorityQueue:
    ...
    def update(self, item, priority):
        ...
        # If item not in priority queue, do the same thing as self.enqueue.
...
class PriorityQueueWithFunction(PriorityQueue):
    """
    Implements a priority queue with the same enqueue/dequeue signature of the
    ...
    def enqueue(self, item):
        ...
        PriorityQueue.enqueue(self, item, self.priorityFunction(item))
