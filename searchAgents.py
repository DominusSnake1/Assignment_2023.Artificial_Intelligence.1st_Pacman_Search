...
class CornersProblem(search.SearchProblem):
    ...
    def isFinalState(self, state):
        ...
        if (currentState in self.corners) and (currentState not in visitedCornersList):
            visitedCornersList.append(currentState)
        return len(visitedCornersList) == len(self.corners)
    ...
    def getNextStates(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                successors.append(((nextNode, successorCorners), action, 1))
